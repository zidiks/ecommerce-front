<template>
  <div class="controls-arrow">
    <svg class="arrow" :class="{'arrow-inactive': arrowDisabled,'arrowBack': arrowBack}" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
