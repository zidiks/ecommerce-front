<template>
  <div class="controls-arrow" :style="`transform: rotate(${arrowDirection}deg)`">
    <svg :class="`arrow${arrowDisabled ? '-inactive' : ''}`" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
